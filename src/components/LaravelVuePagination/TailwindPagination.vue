          ...
          <a
            ...
            :class="
              page == slotProps.computed.currentPage
                ? 'z-10 flex items-center justify-center px-3 h-8 leading-tight text-primary border border-primary bg-primary/10 hover:bg-primary/20 hover:text-primary dark:border-primaryDark dark:bg-primaryDark/20 dark:text-primaryDark'
