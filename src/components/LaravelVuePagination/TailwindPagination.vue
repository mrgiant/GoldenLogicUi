<template>
  ...
  <!-- Help text -->
  <span class="text-sm text-gray-700 dark:text-gray-400"  v-if="slotProps.computed.total > slotProps.computed.perPage" >
      Showing <span class="font-semibold text-gray-900 dark:text-white">{{ slotProps.computed.from }}</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ slotProps.computed.to }}</span> of <span class="font-semibold text-gray-900 dark:text-white">{{ slotProps.computed.total }}</span> Entries
  </span>
