...
<template>
  ...
  <!-- Modal -->
  <div class=" fixed left-0 top-13 h-full w-full overflow-y-auto overflow-x-hidden outline-hidden inset-0 bg-black/80!"
    ...
    <div
      ...
      <div
        ...
        <div v-if="isLoadingComputed" role="status"
          ...
          <div class="flex items-center mt-4">
            <svg class="w-10 h-10 text-gray-200 me-3 dark:text-gray-700" aria-hidden="true"
        ...
        <!-- Modal body -->
        <div v-show="!isLoadingComputed" class="relative overflow-y-auto gl_modal_body" :class="bodyClass">
          <slot name="body"></slot>
        </div>
