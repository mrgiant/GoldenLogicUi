...
<template>
    ...
    >
        <div class="pointer-events-none relative h-[calc(100%-1rem)] w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:h-[calc(100%-3.5rem)]  bg-white rounded-lg shadow-xl dark:bg-gray-700" :class="max_width">
            <!-- Modal content -->
            <div class="pointer-events-auto relative flex max-h-[100%] w-full flex-col    outline-none  ">
                <!-- Modal header -->
