<template>
    <component
        ...
        :class="`  ${is_disabled ? 'cursor-not-allowed opacity-50':''}   ${icon || svg_icon ? 'flex':''}    h-10  items-center justify-center gap-2 focus:outline-hidden text-sm px-3 py-2   font-medium   ${has_border_reduced ? 'rounded-xl':''}  ${buttonTypeClass} ${classes}`"
    >
