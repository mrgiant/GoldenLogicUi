<template>
  ...
  <div v-if="isOpen" class="fixed inset-0 z-99999 overflow-y-auto" role="dialog" aria-modal="true">
      ...
      <div
        ...
        <div
          ...
          <component v-else is="button" disabled
            ...
            <svg aria-hidden="true" role="status" class="inline w-4 h-4 me-3 animate-spin" viewBox="0 0 100 101"
          ...
          <gl-button @click="cancelAction" tag="button" button_type="light">{{ cancelButton }}
          </gl-button>
