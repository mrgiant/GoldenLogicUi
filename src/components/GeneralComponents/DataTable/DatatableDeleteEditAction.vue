<template>
    ...
    >
        ...
        <div
            v-show="open"
            class="xs:right-[unset] lg:right-[30px]  absolute z-10 mt-6 origin-top-right bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600"
        >
            <ul
